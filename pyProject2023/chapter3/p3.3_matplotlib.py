...
y1=df.iloc[0,1:].tolist()
y2=df.iloc[1,1:].tolist()
y3=df.iloc[2,1:].tolist()
y4=df.iloc[3,1:].tolist()
y5=df.iloc[4,1:].values.tolist()
print(y1)

ax1=fig.add_subplot(2,3,1) #add_subplot(行数,列数,位置号)
